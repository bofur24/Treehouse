...
// var firstNumFloat = parseFloat(firstNum);
// var secondNum = prompt('Enter your second number');
// var secondnumFloat = parseFloat(secondNum);
// var add = firstNumFloat + secondnumFloat;
// var subtract = firstNumFloat - secondnumFloat;
// var division = firstNumFloat / secondnumFloat;
// var multiplication = firstNumFloat * secondnumFloat;
// var messageTitle = '<h1>Math with the nubmers ' + firstNumFloat + ' and ' + secondnumFloat + '</h1> <br> <p>' 
// + firstNumFloat + ' + ' + secondnumFloat + ' = ' + add 
// + '<br>' + firstNumFloat + ' - ' + secondnumFloat + ' = ' + subtract 
// + '<br>' + firstNumFloat + ' / ' + secondnumFloat + ' = ' + division 
// + '<br>' + firstNumFloat + ' * ' + secondnumFloat + ' = ' + multiplication + '</p>';                 
